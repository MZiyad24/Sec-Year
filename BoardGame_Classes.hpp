// Class definition for BoardGame classes
...
public:
   ...
   virtual bool is_winner(char i) = 0;
   ...
   virtual int check_res()=0;
};
//////////////////////////////////////////
class pyramdic_X_O_board:public Board
{
public:
    pyramdic_X_O_board();
...
class RandomPlayer: public Player {
    ...
    public:
        ...
        void get_move(int& x, int& y, int game);
};
